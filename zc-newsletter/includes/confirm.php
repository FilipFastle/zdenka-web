...
function zcn_page_response($title, $text, $btn_label) {
    ...
    <style>*{margin:0;padding:0;box-sizing:border-box}body{background:#1C1A18;min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:"DM Sans",sans-serif;padding:24px}
    .card{background:#fff;border-radius:20px;padding:48px 40px;max-width:440px;width:100%;text-align:center;box-shadow:0 24px 64px rgba(0,0,0,.35)}
    ...
    a{display:inline-block;padding:12px 28px;background:#B8A47A;color:#1C1A18;text-decoration:none;border-radius:8px;font-weight:700;font-size:13px}</style>
